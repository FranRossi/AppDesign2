...
export class BugsService {
  ...
  fixBug(bugId: string, fixingTime: string) {
    this.setHeader();
    this.headersProject.append('fixingTime', fixingTime);
    return this.http.patch(this.endpoint  + `/${bugId}`,  {headers: this.headersProject});
  }
}
